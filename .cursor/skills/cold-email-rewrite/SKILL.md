...
description: >-
  Second-pass rewrite and humanization of B2B cold outreach emails for customer
  discovery. Use when the user wants to compare drafts, tighten copy, critique
  line-by-line, or rewrite an email that sounds too sales-y. Distinct from
  cold-email (first draft) and cold-outreach-sequence (multi-touch LinkedIn+email).
  Read LOCAL-OVERLAY.md in this directory before writing.
license: MIT
metadata:
  version: 1.0.0
